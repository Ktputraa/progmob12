...
import kotlinx.android.synthetic.main.activity_bali.*
import kotlinx.android.synthetic.main.activity_history.*
import kotlinx.android.synthetic.main.activity_surabaya.*
...
class SurabayaActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnsurabayaback.setOnClickListener { v: View? ->
            val intent = Intent(this@SurabayaActivity, listhotel::class.java)
